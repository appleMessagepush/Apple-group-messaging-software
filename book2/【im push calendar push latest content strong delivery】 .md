# [IM push calendar push latest content strong delivery] HTTP/2 protocol: This is a newer and recommended communication protocol. Using the HTTP/2 protocol, you can create TLS (Transport Layer Security)
